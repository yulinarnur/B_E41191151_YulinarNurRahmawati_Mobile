...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder> {
    ...
    public interface onSelectData {
        View onCreatView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState);
    ...
    public void onBindViewHolder(MovieAdapter.ViewHolder holder, int position){
        ...
        holder.tvRealeseDate.setText(data.getRealeseDate());
        ...
        holder.cvFilm.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){onSelectData.onSelected(data);}
        });
    }
